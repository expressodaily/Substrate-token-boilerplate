...
use erc20_multi_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	erc20_multi_runtime::api::dispatch,
	erc20_multi_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/erc20_multi_runtime.compact.wasm")
);
